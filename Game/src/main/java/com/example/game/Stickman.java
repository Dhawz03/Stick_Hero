...
import static com.example.demo19.*;
...
public class Stickman {
    ...
    public void stopGrowing(com.example.demo19.Platform platform, StickmanGame stickmangame) {
        /*isrotating=true;
    ...
    private void rotatestick(com.example.demo19.Platform platform, StickmanGame stickmangame) {
        rotateangle+=1;
    ...
    public void startWalking(com.example.demo19.Platform platform, StickmanGame stickmangame) {
    ...
    private void walkStickman(com.example.demo19.Platform platform, StickmanGame stickmangame) {
    ...
    private void stickmanfall(com.example.demo19.Platform platform, StickmanGame stickmanGame) {
        ...
        fallingTimeline.setOnFinished(e->{
            ...
            stickmanGame.stage.setScene(stickmanGame.endscene);
            stickmanGame.revive.setOnAction(ea->{
    ...
    private void fallStickman(com.example.demo19.Platform platform, StickmanGame stickmanGame) {
        stickmanY += 0.5;
        stickman.setTranslateY(stickmanY);
    }


    public void resetPosition(com.example.demo19.Platform platform, StickmanGame stickmanGame) {
        ...
        root.getChildren().removeAll(platform.redbox);
        platform.redbox=new Rectangle((root.getWidth() * (newrect.get(1)+newrect.get(0)) / 200)-4, root.getHeight()-PLATFORM_HEIGHT,8,8);
        platform.redbox.setFill(Color.RED);
        root.getChildren().add(platform.redbox);
